...
window.OS = {
  ...
  "pots": {
    ...
    "cowrywise": 305000,
    "buffer": 0,
    "note": "Payday A landed and is CONFIRMED in the account: ₦143 opening + ₦962,228 converted = ₦962,371. ₦934,600 of it goes out the same day, so the real free number is ₦27,771 to the 14th. Cowrywise is RING-FENCED and never counts toward the goals — and it now also hosts the Goal 1 account, which is a name clash that has to be resolved before December.",
    "bank_free": 27771,
    "bank_sub": "₦934,600 of it is already committed — ₦27,771 is what is actually free to the 14th"
  },
  "goals": [
    {
      "id": "goal1",
