...
window.OS = {
  ...
  "pots": {
    ...
    "cowrywise": 405000,
    "buffer": 0,
    "note": "Payday A landed AND the four biggest transfers went out the same day: building ₦500,000, son's school ₦100,000, Cowrywise ₦100,000 (+₦250 charge), girlfriend ₦50,000 = ₦750,250. Closing balance ₦211,787, which leaves ₦334 of unattributed bank charges — ₦584 of charges on the day in total. Reconciles to the naira. ₦184,600 across 9 lines is still to be paid across this week, so the real free number is ₦27,187 to the 14th. Cowrywise is RING-FENCED and never counts toward the goals — and it now also hosts the Goal 1 account, which is a name clash that has to be resolved before December.",
    "bank_free": 27187,
    "bank_sub": "₦184,600 of it is still committed this week — ₦27,187 is what is actually free to the 14th"
  },
  "goals": [
    {
      "id": "goal1",
  ...
  "warnings": [],
  "gaps": [
    "POTS ARE STALE: balances as of 2026-09-02, ledger runs to 2026-09-03. The money figures on every page are older than the day being shown.",
    "MONEY LEDGER IS 1 DAY(S) BEHIND: last row 2026-09-02.",
    "HABIT LOG IS 1 DAY(S) BEHIND: last entry 2026-09-02."
  ],
  "content_hash": "a641bdefc42a7680"
};
