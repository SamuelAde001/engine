...
window.OS = {
  ...
  "ledger": [
    ...
    },
    {
      ...
      "shipped": "**SENT 12:07pm** — every pomo closed, picture lock held, render walked away from. 2.5 days past the client deadline.",
      "focus_logged": null,
      "focus_committed": null,
      "habits_hit": null,
      "habits_set": null,
  ...
  "countdowns": [
    ...
    {
      "date": "2026-09-14",
      "label": "Payday B — ₦416,325 in, ₦146,041 to Goal 1",
      "kind": "money",
      "note": "₦40,000 also goes to his sister. He may still be travelling back from Kaduna — the account has to be known before he leaves."
    },
    {
      "date": "2026-10-11",
  ...
  "warnings": [
    "POTS ARE STALE: balances as of 2026-08-27, ledger runs to 2026-09-02. The money figures on every page are older than the day being shown.",
    "MONEY LEDGER IS 5 DAY(S) BEHIND: last row 2026-08-28.",
    "HABIT LOG IS 6 DAY(S) BEHIND: last entry 2026-08-27.",
    "HABIT LOG CONTAINS HABITS THAT ARE NO LONGER TRACKED: Bible study (morning), Fasted, No masturbating, No social media (detox), Prayed. History is fine to keep; just do not read it as current."
  ],
  "content_hash": "bde74acdd50ab178"
};
